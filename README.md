...
A multi-system emulator frontend for Windows built with WPF and .NET 8, inspired by [OpenEmu](https://openemu.org/) on macOS. Games are organized by console in a clean library interface. Emulation is handled by [libretro](https://www.libretro.com/) cores loaded at runtime — no cores are bundled. If you're looking for the Linux version of Emutastic, head to [Emutastic for Linux](https://github.com/codingncaffeine/Emutastic-For-Linux).
