...
namespace Emutastic.Services
{
    ...
    public sealed class ThemeService
    {
        ...
        private static ThemeColors GetLightColors() => new()
        {
            ...
            Green = "#28C840",
            ScrollThumb = "#C7C7CC",
            ScrollThumbHover = "#A1A1A6",
            ScrollThumbDrag = "#8E8E93",
            ScrollTrack = "#F0F0F2",
            PlayBtnBg = "#E8E8ED",
            PlayBtnBorder = "#D1D1D6",
            PlayBtnHoverBg = "#D1D1D6",
            PlayBtnHoverBorder = "#C7C7CC",
            PlayBtnPressedBg = "#F0F0F2",
            AccentPressed = "#A01818",
            AccentDisabled = "#F0B0B0",
            TrafficYellow = "#FEBC2E",
            TrafficYellowHover = "#E5A800",
            TrafficGreenHover = "#1FA832",
            TrafficRed = "#FF5F57",
            ...
            PillBorder = "#D1D1D6",
            PillHoverBg = "#C7C7CC",
            PillPressedBg = "#D8D8DD",
            PillFg = "#3A3A3C",
            PillMutedFg = "#8E8E93",
            Surface = "#D8D8DD",
            SurfaceHover = "#E0E0E2",
            SurfaceActive = "#C7C7CC",
            ContentBg = "#F8F8FA",
            Warning = "#E68A00",
            PillGroupBg = "#EBEBED",
            AchievementGold = "#D4A800",
